...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`shrink-0 border-r border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800 p-4 flex flex-col justify-between transition-all duration-200 ${
...
<button
    ...
    collapsed ? "w-[32px] mx-auto" : "w-[60px]"
    }`}
...
>
    ...
    className={`absolute top-1/2 -translate-y-1/2 flex items-center justify-center h-6 w-6 rounded-full transition-all duration-200 ${
        ...
        : "bg-transparent text-stone-900 left-1"
    }`}
    >
